...
export const GetIssueListQuery = gql`
query getIssueList($date: GraphQLLong! ){
  getIssueList(date : $date)
  {
    issueID
    email
    text
...
export const RequestIssueCompleteMutation = gql`
mutation requestIssueComplete($issueID: Int! ){
  requestIssueComplete(issueID : $issueID)
}
`;
...
export const RequestWithdrawalHistoryQuery = gql`
query RequestWithdrawalHistory{
...
export const GetEventTimeDataQuery = gql`
query getEventOpenTime{
  getEventOpenTime
  {
    startTime
    endTime
...
export const SetEventTimeDataMutation = gql`
mutation setEventOpenTime($startTime: String!, $endTime:String!){
  setEventOpenTime(startTime:$startTime, endTime:$endTime)
  {
    startTime
    endTime
  }
